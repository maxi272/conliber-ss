...
<form method="post" autocomplete="off" style="margin-block-end: unset">
    <div class="h-48 flex flex-wrap content-center justify-center text-center">
        <div class=" middlePart middlePart3 flex-col justify-center text-center" style="padding-top: 1%">
            ...
            Noch mehr Bücher? Dann scanne weiter.
            </h1>
            <br>
            <div class="RfidImg">
                <img src="">
...
<div class="h-48 flex flex-wrap content-end ">
    ...
    <div class="px-5">
                ...
                <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                    ...
                    <div class="flex items-center p-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                        ...
                        <div>
                            <p class="mb-2 text-sm font-light text-gray-600 ">
                                Du hast bereits Bücher gescannt:
                            </p>
    ...
    <button type="submit" name="submitbutton" class="mt-10 mb-5 focus:outline-none button button-primary  font-bold text-lg px-6 pt-3 pb-3 rounded bg-purple-500 hover:bg-purple-600 text-white" id="otpSubmit">Bestätigen</button>
